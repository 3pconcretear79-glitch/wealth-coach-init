...
const DEMO_RESPONSES: Record<string, string> = {
  default: "I'd be happy to help with your financial questions! You can ask me about investment strategies, portfolio allocation, retirement planning, tax optimization, or any other wealth management topic.",
  invest: "Great question! For a diversified investment approach, I'd recommend:\n\n- **Index Funds** (40-60%) - Low-cost, broad market exposure\n- **Bonds** (20-30%) - Stability and income\n- **International Equities** (10-20%) - Geographic diversification\n- **Alternative Assets** (5-10%) - REITs, commodities\n\nWould you like me to create a personalized plan?",
  retire: "Retirement planning is crucial! Key steps:\n\n1. **Calculate your number** - Typically 25x annual expenses\n2. **Maximize tax-advantaged accounts** - 401(k), IRA, Roth IRA\n3. **Automate contributions** - Pay yourself first\n4. **Review annually** - Rebalance and adjust\n\nAt 7% average return, $500/month starting at 30 gives ~$1.2M by 65.",
  save: "Solid savings framework:\n\n- **Emergency Fund** - 3-6 months expenses in high-yield savings\n- **50/30/20 Rule** - 50% needs, 30% wants, 20% savings\n- **Automate transfers** - Set up automatic savings on payday\n- **High-yield savings** - Currently offering 4-5% APY",
};
...
export default function ChatInterface() {
  const [messages, setMessages] = useState<Message[]>([
    { id: "welcome", role: "assistant", content: "Hello! I'm your AI Wealth Advisor. I can help with investment strategies, retirement planning, budgeting, and more. What financial topic would you like to explore today?" },
  ]);
    ...
    <section id="chat" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-400">Ask any financial question and experience the power of AI wealth management.</p>
        </div>
        <div className="rounded-2xl border border-gray-800 bg-gray-900/70 overflow-hidden shadow-2xl shadow-black/50">
          ...
          <div className="border-t border-gray-800 p-4">
            ...
            <div className="flex gap-2 mt-3">
              {["How should I invest $10k?", "Retirement planning tips", "Help me save more"].map((s) => (
                <button key={s} onClick={() => setInput(s)} className="text-xs text-gray-500 border border-gray-800 rounded-full px-3 py-1 hover:border-gold-500/30 hover:text-gray-300 transition-colors">{s}</button>
              ))}
            </div>
          </div>
        </div>
