  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hello! I'm your AI Wealth Advisor. I can help with investment strategies, retirement planning, budgeting, and more. What financial topic would you like to explore today?",
    },
  ]);
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-400">
            Ask any financial question — experience the power of AI wealth management.
          </p>
        </div>
              ...
              >
                <div
                  className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
                    msg.role === "user"
                      ? "bg-gold-500 text-gray-950 rounded-br-md"
          ...
          <div className="border-t border-gray-800 p-4">
            <div className="flex gap-3">
              <input
                ...
                placeholder="Ask about investments, retirement, savings..."
                className="flex-1 rounded-xl border border-gray-700 bg-gray-800 px-4 py-3 text-sm text-white placeholder-gray-500 focus:border-gold-500 focus:outline-none focus:ring-1 focus:ring-gold-500 transition-colors"
              />
              <button
                onClick={handleSend}
            ...
            <div className="flex gap-2 mt-3">
              {["How should I invest $10k?", "Retirement planning tips", "Help me save more"].map(
                (suggestion) => (
                  <button
                    key={suggestion}
                    onClick={() => setInput(suggestion)}
                    className="text-xs text-gray-500 border border-gray-800 rounded-full px-3 py-1 hover:border-gold-500/30 hover:text-gray-300 transition-colors"
                  >
                    {suggestion}
                  </button>
                )
