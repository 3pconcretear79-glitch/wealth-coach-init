    ...
    <section className="relative overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#chat" className="text-sm text-gray-400 hover:text-white transition-colors">
            AI Chat
          </a>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pt-20 pb-28 max-w-4xl mx-auto">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          <a href="#pricing" className="btn-primary px-8 py-4 text-base">
            Start Free Trial
          </a>
          <a href="#chat" className="btn-secondary px-8 py-4 text-base">
            Try AI Chat Demo
          </a>
        </div>
